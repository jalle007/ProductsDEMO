...
namespace ProductsApp.Dashboard
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ImageService>(provider => new ImageService(provider.GetService<OnFeetContext>(), 
            imageStorageConfig["ConnectionString"], imageStorageConfig["Container"]));
